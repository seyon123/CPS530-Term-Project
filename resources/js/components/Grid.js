  ...
  return (
    <div className={classes.root}>
      ...
      <Grid item xs={6}>
        ...
        <Grid item xs={6}>
          <Paper className={classes.paper}>Currently used by Walmart, Bethesda, NASA and shutterstock. Ideal for websites that provide an easy to use, clean and attractive user interface.</Paper>
        </Grid>
        <Grid item xs={6}>
          <Paper className={classes.paper}>Currently used to power startups.co, Fox47, and various other sites. Ideal for developers who want to build B2B or enterprise websites that will evolve with changing web trends.</Paper>
        </Grid>
      </Grid>
    </div>
  );
